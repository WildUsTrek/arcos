export const i18n = {
  ...
  allUnusableTip:
    'Tutte le carte sono inutilizzabili, devi scartare una carta cliccando con il tasto destro o tenendo premuto a lungo su di essa',

  // %ss = 'brick', %sp = 'bricks'
  'Your %sp': 'I tuoi/Le tue %sp', // Your bricks
  "Opponent's %sp": "%sp dell'avversario", // Opponent's bricks

  '%s1. Reach %s2 to win': '%s1. Raggiungere %s2 per vincere', // Your tower/bricks/gems/recruits = n. Reach 100 to win
  ...
  'Review cards': 'Rivedi le carte',
  'Hide cards': 'Nascondi le carte',
  ...
  Opponent: 'Sfidante',
  Challenge: 'Sfida',
  'Mode effect': 'Effetto modalita',
  'Victory conditions': 'Condizioni di vittoria',
  'AI Profile': 'Profilo IA',
  balanced: 'Bilanciato',
  builder: 'Costruttore',
  raider: 'Incursore',
  ...
  'Next level unlocked': 'Prossimo livello sbloccato',
  'Start battle': 'Inizia battaglia',
  'Replay final battle': 'Rigioca la battaglia finale',
  'Last completed level': 'Ultimo livello completato',
  ...
  'Minimum is starting %s1 + 1 = %s0': 'Il minimo è %s1 iniziale + 1 = %s0',
  'Minimum is MAX(%s1+%s2, %s3+%s4, %s5+%s6) + 1 = %s0':
    'Il minimo è MAX(%s1+%s2, %s3+%s4, %s5+%s6) + 1 = %s0',
  ...
  Graphics: 'Grafica',
  'Disable animation': 'Disabilita animazione',
  Pixelation: 'Pixelation',
  'Visual Preset': 'Preselezione visiva',
  'Filter may slow down the game': 'Il filtro può rallentare il gioco',
...
il rosso rappresenta il Generatore Pietra, che produce i Mattoni; il blu rappresenta il Generatore Magia, che produce le Gemme; il verde rappresenta il Generatore Zoo, che produce gli Animali.`,
  ...
  'With no usable or discardable card, you must surrender. Open the "%s1" window and click "%s2" (or ask your opponent to do so)':
    'Senza carte utilizzabili o scartate, devi arrenderti. Apri la finestra "%s1" e clicca su "%s2" (o chiedi al tuo avversario di farlo)',
